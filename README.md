...
新模板族、镜头语言级的会员动效系列、配套的批量生产 Skill，**都在微信群里陆续发**，
付费会员的知识星球入口也只在群内公布：

- **微信群（主阵地）**：逐步开放的完整版、更新通知、答疑，知识星球入口在群里发；
- **个人微信**：会员 / 定制咨询；
- **抖音 / 小红书**：纯引流，只看更新预告，完整内容不在那边发。
...
**Skill 与会员动效系列的领取方式 → 进微信群逐步开放（见上方「扫码联系」），或见预览站首页说明**

## 更新路线图（持续上新，周更）

五个新模板族制作中，完成一族上线一族（预览站先看，完整版在微信群逐步开放）：
