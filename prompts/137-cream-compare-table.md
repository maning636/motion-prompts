...
【动效名称】对比表（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版对比构图：3 个对象 × 5 个维度的横向对比表，每行自动标出最优项，适合模型 / 工具 / 方案的多维比较。
【标签】对比表 / 多维对比 / 表格 / 模型对比 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-compare-table · 对比表（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: compare（对比构图）。

- 变量: title,objects,dimensions,valuesA,valuesB,valuesC
