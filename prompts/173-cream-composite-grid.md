...
【动效名称】组合网格（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版网格展示：将 2–4 个已有模板嵌入同一画面，每个格子可独立指定模板和缩放比例，实现多组件同屏组合展示。
【标签】组合 / 多画面 / 网格 / 复用 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-composite-grid · 组合网格（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: grid（网格展示）。

- 变量: title,subtitle,mediaTL,mediaTR,mediaBL,mediaBR,scaleTL,scaleTR,scaleBL,scaleBR
