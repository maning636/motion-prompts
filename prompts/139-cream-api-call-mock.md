...
【动效名称】API 调用（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版对比构图：左右分栏展示 API 请求与响应 JSON，适合演示 REST/JSON 接口调用。
【标签】API / Mock / JSON / 接口 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-api-call-mock · API 调用（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: compare（对比构图）。

- 变量: title,subtitle,method,endpoint,request,response
