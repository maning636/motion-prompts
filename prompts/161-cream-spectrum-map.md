...
【动效名称】谱系图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版光谱坐标：水平轴两端标注对立维度，多个对象按位置分布，适合展示模型/工具/策略的连续差异。
【标签】谱系 / 连续轴 / 定位 / 分布 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-spectrum-map · 谱系图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: spectrum（光谱坐标）。

- 变量: title,subtitle,leftLabel,rightLabel,items,positions
