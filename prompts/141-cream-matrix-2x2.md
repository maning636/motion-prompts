...
【动效名称】2x2 矩阵（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版四象限：十字轴把画面分成四象限，每个对象按两个维度坐标落入对应位置，适合模型 / 产品 / 策略定位。
【标签】2x2 矩阵 / 定位 / 象限 / 策略 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-matrix-2x2 · 2x2 矩阵（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: quadrant（四象限）。

- 变量: title,subtitle,xAxis,yAxis,q1,q2,q3,q4,items
