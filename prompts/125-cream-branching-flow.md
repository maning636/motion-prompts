...
【动效名称】分支流程（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版分支辐射：根节点 → 判断菱形 → 两个结果分支，适合 if/else、权限判断等简单决策。
【标签】分支 / 流程图 / 判断 / if/else / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-branching-flow · 分支流程（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: branch（分支辐射）。

- 变量: title,subtitle,root,question,yesLabel,noLabel
