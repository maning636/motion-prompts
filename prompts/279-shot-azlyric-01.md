...
【动效名称】跟读填色
【分类】镜头动效
【用途】标语逐词从左到右填色点亮，活跃词下带读指下划线、读完保持——视线被旁白节奏牵着走
【标签】文字 / 跟读 / 节奏
【画幅】1920×1080（16:9 横屏）
【时长】5 秒，动画确定性、首尾可循环

【视觉与设计规范】
标语逐词从左到右填色点亮，活跃词下带读指下划线、读完保持——视线被旁白节奏牵着走。
【可改文案】词组(逗号分隔)（默认「我们把,复杂的,工作,交给,简单工具」）、强调色（默认「#00FF00」）、背景色（默认「#0A0A0F」）、文字色（默认「#F4F4F2」）
