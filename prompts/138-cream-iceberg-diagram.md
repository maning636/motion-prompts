...
【动效名称】冰山图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版对比构图：左侧冰山图形展示可见与隐藏部分的比例，右侧文字块解释显性 UI 与隐性机制，适合表达表面现象与深层原因。
【标签】冰山图 / 可见与不可见 / 比例 / 知识讲解 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-iceberg-diagram · 冰山图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: compare（对比构图）。

- 变量: title,subtitle,visible,visibleDesc,hidden,hiddenDesc
