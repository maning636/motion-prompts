...
【动效名称】仪表盘（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版仪表盘：半圆仪表盘 + 分段弧线 + 数值滚动，适合单指标健康度、完成率、评分。
【标签】仪表盘 / 单指标 / 健康度 / 数据 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-gauge-meter · 仪表盘（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: gauge（仪表盘）。

- 变量: title,subtitle,value,min,max,unit,labelLow,labelMid,labelHigh
