...
【动效名称】环形图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版环形图：4 块以内的占比构成图，中心数字为视觉锚，适合份额、构成、占比类数据。
【标签】环形图 / 占比 / 构成 / 数据 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-donut-chart · 环形图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: donut（环形图）。

- 变量: title,labels,values,centerNumber,centerLabel
