...
【动效名称】概念等式（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版链式流程：A + B = C 的教科书式等式布局，左右两侧为输入要素，右侧为结果，结果用 accent 高亮。
【标签】概念等式 / A+B=C / 组合 / 要素 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-concept-equation · 概念等式（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: chain（链式流程）。

- 变量: title,subtitle,leftA,leftADesc,leftB,leftBDesc,result,resultDesc
