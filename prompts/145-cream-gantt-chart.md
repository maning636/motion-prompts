...
【动效名称】甘特图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版柱状图：左侧任务列表 + 右侧时间轴条带，用条带长度表示起止周，关键里程碑用圆点标注，适合项目排期与 Sprint 规划。
【标签】甘特图 / 项目排期 / Sprint / 时间轴 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-gantt-chart · 甘特图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: bars（柱状图）。

- 变量: title,subtitle,weeks,tasks,starts,ends,milestones
