...
【动效名称】原型变形长卡
【分类】镜头动效
【用途】正圆呼吸一拍做预备，轮廓 24f 连续变形长成圆角卡片，内容再淡入，logo→UI 容器经典入场
【标签】变形 / 入场 / 生长
【画幅】1920×1080（16:9 横屏）
【时长】5 秒，动画确定性、首尾可循环

【视觉与设计规范】
正圆呼吸一拍做预备，轮廓 24f 连续变形长成圆角卡片，内容再淡入，logo→UI 容器经典入场。
【可改文案】卡标题（默认「增长引擎」）、卡描述（默认「从一颗原型长出来的功能」）、角标（默认「NEW」）、强调色（默认「#00FF00」）、背景色（默认「#0A0A0F」）、文字色（默认「#F4F4F2」）
