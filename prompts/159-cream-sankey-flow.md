...
【动效名称】Sankey 流图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版桑基流向：左右流向图，节点竖条 + 曲线连接，适合展示流量、资源、用户转化分布。
【标签】Sankey / 流图 / 转化 / 数据 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-sankey-flow · Sankey 流图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: sankey（桑基流向）。

- 变量: title,subtitle,sources,targets,values
