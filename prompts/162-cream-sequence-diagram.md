...
【动效名称】时序图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版泳道时序：标准 UML 时序图：参与者、生命线、消息箭头，适合 API 调用与系统交互。
【标签】时序图 / UML / API / 交互 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-sequence-diagram · 时序图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: lanes（泳道时序）。

- 变量: title,subtitle,actors,steps
