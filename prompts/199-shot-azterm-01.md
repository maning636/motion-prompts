...
【动效名称】终端打字引爆
【分类】镜头动效
【用途】暗色终端逐字敲命令、方块光标方波闪，回车帧 6f 急推进命令行硬切产品界面，开发者产品开场引信
【标签】打字机 / 终端 / 开场
【画幅】1920×1080（16:9 横屏）
【时长】5 秒，动画确定性、首尾可循环

【视觉与设计规范】
暗色终端逐字敲命令、方块光标方波闪，回车帧 6f 急推进命令行硬切产品界面，开发者产品开场引信。
【可改文案】终端命令（默认「npx hyperframes re」）、产品页标题（默认「渲染完成 · 3 个成片」）、强调色（默认「#00FF00」）、背景色（默认「#0A0A0F」）、文字色（默认「#F4F4F2」）
