...
【动效名称】翻面生态接入
【分类】镜头动效
【用途】旧页一口气快翻 180°（侧棱瞬闪）落成新中枢页，五图标同帧弹现、五彩虹光管同帧齐连，管内脉冲持续输送
【标签】翻面 / 生态 / 集成
【画幅】1920×1080（16:9 横屏）
【时长】5 秒，动画确定性、首尾可循环

【视觉与设计规范】
旧页一口气快翻 180°（侧棱瞬闪）落成新中枢页，五图标同帧弹现、五彩虹光管同帧齐连，管内脉冲持续输送。
【可改文案】中枢页标题（默认「集成中心」）、强调色（默认「#00FF00」）、背景色（默认「#0A0A0F」）、文字色（默认「#F4F4F2」）
