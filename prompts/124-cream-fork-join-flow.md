...
【动效名称】并行 / 汇合流程（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版分支辐射：顶部 Coordinator 同时分叉到多个并行 Worker，底部汇合为 Merge 节点，强调并发与同步等待。
【标签】并行 / 汇合 / 流程图 / 并发 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-fork-join-flow · 并行 / 汇合流程（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: branch（分支辐射）。

- 变量: title,subtitle,coordinator,workers,mergeLabel
