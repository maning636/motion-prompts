...
【动效名称】散点图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版散点图：X/Y 双轴散点分布，带趋势辅助线，适合展示相关性、模型规模与效果关系。
【标签】散点图 / 相关性 / 数据 / 趋势 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-scatter-plot · 散点图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: scatter（散点图）。

- 变量: title,subtitle,xLabel,yLabel,xValues,yValues,labels
