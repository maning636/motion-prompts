...
【动效名称】Kanban 看板（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版界面拟物：四列任务看板，每列显示任务卡片数，焦点列用 accent 边框高亮，适合展示 Sprint 状态和 workflow 可视化。
【标签】Kanban / 看板 / Sprint / 任务状态 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-kanban-board · Kanban 看板（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: window（界面拟物）。

- 变量: title,subtitle,columns,cards,focusColumn
