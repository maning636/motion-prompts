...
【动效名称】热力图（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版热力图：二维矩阵色块，用 accent 透明度表示强度，适合时间×维度、特征×样本分布。
【标签】热力图 / 矩阵 / 强度 / 数据 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-heatmap-grid · 热力图（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: heatmap（热力图）。

- 变量: title,subtitle,rows,cols,values
