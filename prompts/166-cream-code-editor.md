...
【动效名称】代码编辑器（奶油贴纸）
【分类】奶油贴纸
【用途】奶油纸面贴纸版界面拟物：模拟代码编辑器窗口，含文件头、行号、语法高亮与当前行 accent 高亮，适合演示代码片段和教学。
【标签】代码编辑器 / 代码片段 / 语法高亮 / 教学 / 奶油贴纸
【画幅】1920×1080（16:9 横屏）
【时长】6 秒，动画确定性、首尾可循环

【视觉与设计规范】
# cream-code-editor · 代码编辑器（奶油贴纸版）

奶油纸面贴纸工作台风格，原型: window（界面拟物）。

- 变量: filename,language,code,highlightLine
